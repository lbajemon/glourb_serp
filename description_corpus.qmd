...
subcontinent = corpus_fusion %>% 
  ...
  select(c("nom", "moy_cont", "max_cont", "min_cont")) %>% 
  unique() %>% 
  arrange(nom) 

colnames(subcontinent) = c("Sous-continent", "Moyenne", "Maximum", "Minimum")

grid.table(subcontinent, theme = ttheme_minimal(), rows = NULL)
```
