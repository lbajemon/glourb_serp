...
domain_plot %>% 
  ggplot(mapping = aes(x = domain,
                       y = nb)) +
  geom_col(position = "stack", fill = "#a6d854") +
  ...
  theme_bw() +
  theme(plot.caption = element_text(color = "#d9d9d9",hjust = 0.5))

ggsave("analysis/typology_websites/classement_domaines.png", width = 2200, height = 1600, unit = "px")
...
Plot without distinguishing local from non local queries
...
df_plot %>% 
  ...
  theme_bw() +
  theme(plot.caption = element_text(color = "#d9d9d9",hjust = 0.5))
ggsave("analysis/typology_websites/repartition_types_sites.png", width = 2000, height = 1000, units = "px")
```
