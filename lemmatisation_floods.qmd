...
lemmatisation_en = function(fid, cityname){
    ...
    file = glue::glue("collected_data/floods/english/tokens/tokens_{fid}.csv")
    if(!file.exists(file)){
      
      # read data
      df = read.csv(glue::glue("collected_data/floods/english/clean_data/clean_{fid}.csv")) 
      ...
      write.csv(df_clean, glue::glue("collected_data/floods/english/tokens/tokens_{fid}.csv"), row.names = FALSE)
   }
}
```
...
lemmatisation_hl = function(fid, cityname, hl){
   ...
   file = glue::glue("collected_data/floods/hl/tokens/tokens_{fid}_{hl}.csv")
    if(!file.exists(file)){
      
      # read data
      if(file.exists(glue::glue("collected_data/floods/hl/clean_data/clean_{fid}_{hl}.csv"))){
      df = read.csv(glue::glue("collected_data/floods/hl/clean_data/clean_{fid}_{hl}.csv")) 
      ...
      write.csv(df_clean, glue::glue("collected_data/floods/hl/tokens/tokens_{fid}_{hl}.csv"), row.names = FALSE)
