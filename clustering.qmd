...
# plot
  plot = rainette_plot(
    ...
    show_negative = FALSE,
    text_size = 12,
    cluster_label = c("Internet", "Hydrography", "Classe 3"),
...
```{r run_functions}
# read datasets
data_city_river = read.csv(path, sep = ",", header = TRUE, stringsAsFactors = FALSE) 
coucou = read.csv("input_data/data_city_river.csv")
