...
df = df %>% 
  ...
  mutate(snippet_id = paste0(fid, "_", position)) # create a unique id for each snippet
df = df[,c(1:5,8:13,28,33,34,48)]
write.csv(df, "collected_data/hl/df_tokens_hl1.csv", row.names = FALSE)
```

Results have been found for 369 queries, out of 372.
...
# simplify the resulting dataframe and save it
df_compile = df_compile[,c(1:5,8:13,28,42:44)]
...
df_compile = df_compile[,c(1:5,8:13,25,40:42)]
...
df_compile = df_compile[,c(1:5,8:13,26,36:38)]
